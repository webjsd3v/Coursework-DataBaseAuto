...
char *choices_save_rus[] = {
			...
			"2. Сохранить как, без шифр.",
			"2. Сохранить как , с шифр.",
			"9. Выход",
};

int n_choices_save_rus = sizeof(choices_save_rus) / sizeof(char *); // трюк плдучения количества записей
...
void print_list_save(WINDOW *menu_win, int highlight2) // прорисовка меню сохранения
{
	int x, y, i,max_x;
